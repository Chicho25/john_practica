...
<?php $mesaje_alerta = ""; ?>
<?php if(isset($_POST['reg_empresa'])){
      $reg = $conexion -> query("INSERT INTO espresas(nombre_empresa,
                                                         email,
                                                         area_negocios,
                                                         descripcion,
                                                         telefono,
...
<main role="main" class="container" style="margin-top: 80px;">
  ...
  <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm" style="background-color:#1c7c1a;">
    ...
    <div class="lh-100">
      <h6 class="mb-0 text-white lh-100">Registrar Empresa</h6>
      <small>Registro de Empresa</small>
    </div>
  </div>
  ...
  <div class="form-row">
        <div class="form-group col-md-12">
          <label for="inputCity">Nombre de la empresa</label>
          <input type="text" name="nombre_empresa" class="form-control" id="inputCity" autocomplete="off">
        </div>
        <div class="form-group col-md-6">
          <label for="inputCity">Email</label>
          <input type="text" name="email" class="form-control" id="inputCity" autocomplete="off">
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-6">
          ...
          <textarea name="descripcion" class="form-control" id="inputCity"></textarea>
        </div>
        <div class="form-group col-md-6">
    ...
    <button type="submit" name="reg_empresa" class="btn btn-primary" style="background-color:#1c7c1a;">Registrar</button>
   </form>
  </div>
