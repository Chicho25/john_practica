...
<?php if(isset($_POST['eliminar'])){
      $reg = $conexion -> query("delete from carreras where id = '".$_POST['id_eliminar']."'");
...
<?php if(isset($_POST['nombre_carrera_edit'])){
      $reg = $conexion -> query("update carreras set descripcion = '".$_POST['nombre_carrera_edit']."' where id = '".$_POST['id_editar']."'");
...
<main role="main" class="container" style="margin-top: 80px;">
  ...
  <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm" style="background-color:#1c7c1a;">
    ...
    <div class="lh-100">
      <h6 class="mb-0 text-white lh-100">Ver Carrera</h6>
      <small>Ver Carrera</small>
    </div>
  </div>
  ...
  <tbody>
    <?php $obrener_carreras = $conexion -> query("SELECT * FROM carreras");
    ...
    <tr>
      ...
      <td>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Carrera # <?php echo $lista_carreras['id']; ?></h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
                  ...
                  Carrera: <b><?php echo $lista_carreras['descripcion']; ?></b><br>
                  STATUS: <b> <?php echo $lista_carreras['stat']; ?></b><br>
                  <h5 style="color:red;">Esta seguro que desea eliminar la carrera</h5>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
              <form class="" action="" method="post">
